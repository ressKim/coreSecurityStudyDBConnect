package com.study.corespringsecuritydbconnect.security.listener;
...
import com.study.corespringsecuritydbconnect.repository.UserRepository;
...
//        createResourceIfNotFound("com.study.corespringsecuritydbconnect.aopsecurity.method.AopMethodService.methodTest", "", roles1, "method");
//        createResourceIfNotFound("com.study.corespringsecuritydbconnect.aopsecurity.method.AopMethodService.innerCallMethodTest", "", roles1, "method");
//        createResourceIfNotFound("execution(* com.study.corespringsecuritydbconnect.aopsecurity.pointcut.*Service.*(..))", "", roles1, "pointcut");
